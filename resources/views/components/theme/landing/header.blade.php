        ...
        <div class="container px-5">
          ...
          <div id="navbarNav" class="offcanvas offcanvas-end">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a href="{{ route('marketplace.how-to-sell') }}" class="nav-link">Jual</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('marketplace') }}" class="nav-link">Beli</a>
                </li>
                <li class="nav-item">
          ...
          @auth
            @if(user()->level == enum('isAdmin'))
              <a href="{{ app_url('dashboard') }}" class="btn btn-primary btn-sm fs-sm rounded d-lg-inline-flex" rel="noopener">
                <i class="bx bx-chevron-left fs-5 lh-1 me-1"></i>
                &nbsp;Kembali ke Laman
              </a>
            @else
              <a href="{{ site_url('user', '/') }}" class="btn btn-outline-secondary btn-sm fs-sm rounded d-lg-inline-flex" rel="noopener">
                <i class="bx bx-chevron-left fs-5 lh-1 me-1"></i>
                &nbsp;Kembali ke Laman
              </a>
            @endif
          @else
              <a href="{{ route('login') }}" class="btn btn-outline-secondary btn-sm fs-sm rounded d-lg-inline-flex" rel="noopener">
