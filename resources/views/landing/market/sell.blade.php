...
<section class="dark-mode bg-dark position-relative pt-5 pb-4 py-md-5">
    ...
    <div class="row justify-content-center text-center pb-4 mb-2">
        <div class="col-xl-6 pt-2">
          <h2 class="h1 mb-4">Jual Guest Post &#128196;</h2>
          <p class="fs-lg mb-3">Pahami prosedur cara kerja mendapatkan cuan dari <span class="fw-bold text-white" style="font-style: italic">guest post</span> dengan mendaftarkan website anda disini</p>
        </div>
    </div>
    <div class="row mt-3">
        ...
        <div class="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-5 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 me-xl-2">
          <div class="card-body pt-3">
            ...
            <p class="fs-sm text-body mb-0">
              Daftar gratis, masukkan situs web Anda, dan tawarkan peluang Guest Post Anda.
            </p>
          </div>
        </div>
      </div>
      <div class="col py-4 my-2 my-sm-3">
        <div class="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-5 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 me-xl-2">
          <div class="card-body pt-3">
            ...
            <p class="fs-sm text-body mb-0">
              Dapatkan pemberitahuan ketika Anda mendapatkan pesanan Guest Post dan gunakan sistem kami untuk mendiskusikan detail dengan Pembeli.
            </p>
          </div>
        </div>
      </div>
        ...
        @if(user()->level == enum('isMembers'))
            @canSell
                <div class="col-12 d-flex justify-content-center">
                    <a href="{{ site_url('seller', '/') }}" class="btn btn-lg btn-primary bg-gradient shadow-primary">&#128073; Daftarkan Website</a>
                </div>
            @else
                <div class="col-12 d-flex justify-content-center">
                    <a href="{{ site_url('user', '/') }}" class="btn btn-lg btn-primary bg-gradient shadow-primary">&#128073; Aktifasi sebagai Seller</a>
                </div>
            @endCanSell
        @elseif(user()->level == enum('isAdmin'))
            <div class="col-12 d-flex justify-content-center">
                <a href="{{ app_url('/') }}" class="btn btn-lg btn-primary bg-gradient shadow-primary">&#128073; Kembali ke laman Admin</a>
            </div>
        @endif
      @else
        <div class="col-12 d-flex justify-content-center">
            <a href="{{ route('login') }}" class="btn btn-lg btn-primary bg-gradient shadow-primary">&#128073; Daftarkan diri</a>
        </div>
      @endauth
    </div>
    </div>
  ...
  <section class="position-relative pt-5 pb-4 py-md-5">
        ...
        <div class="row justify-content-center text-center pb-4 mb-2">
            <div class="col-xl-6 pt-2">
              ...
              <p class="fs-lg text-muted mb-0">Bergabunglah dengan platform Guest Post pertama di Indonesia dan jual backlink di situs web Anda dengan cara yang sah serta dapatkan cuan dengan mudah.</p>
            </div>
        </div>
