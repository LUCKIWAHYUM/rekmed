    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{ Form::open(['route' => ['apoteker.update', 'id' => $apoteker->id_user]]) }}
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-user {{ $errors->has('nama_apoteker') ? 'is-invalid' : '' }}" id="email" name="nama_apoteker" aria-describedby="emailHelp" placeholder="Enter Nama Apoteker." value="{{ $apoteker->user->name }}">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-user {{ $errors->has('nomer_induk') ? 'is-invalid' : '' }}" id="email" name="nomer_induk" aria-describedby="emailHelp" placeholder="Enter Nomer Induk." value="{{ $apoteker->nomer_induk }}">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-user {{ $errors->has('email') ? 'is-invalid' : '' }}" id="email" name="email" aria-describedby="emailHelp" placeholder="Enter Alamat Email." value="{{ $apoteker->user->email }}">
                    ...
                    <div class="form-group mb-3">
                        <label for="exampleEmail1">Status Apoteker<span class="text-danger">*</span></label>
                        <select class="form-control form-control-user {{ $errors->has('status') ? 'is-invalid' : '' }}" id="exampleSelectRounded0" name="status">
                            @foreach([1,2] as $status)
                                ...
                                @php $selected = $apoteker->status == $status ? 'selected' : ''; @endphp
