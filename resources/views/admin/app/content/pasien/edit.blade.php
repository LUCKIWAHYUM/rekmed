        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex">
                    <h6 class="m-0 font-weight-bold text-primary">Perbarui Pasien</h6>
                    <p class="m-0 ml-auto small"><span class="text-danger">*</span> Wajib diisi</p>
                </div>
                <div class="card-body">
                    {{ Form::open(['route' => ['pasien.update', $pasien->id]]) }}
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-3 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-user {{ $errors->has('name') ? 'is-invalid' : '' }}" id="email" name="name" aria-describedby="emailHelp" placeholder="Enter Nama." value="{{ $pasien->nama }}">
                        ...
                        <div class="col-md-3 form-group mb-3">
                            ...
                            <input type="number" class="form-control form-control-user {{ $errors->has('no_ktp') ? 'is-invalid' : '' }}" id="email" name="no_ktp" aria-describedby="emailHelp" placeholder="Enter Nomer KTP." value="{{ $pasien->no_ktp }}">
                        ...
                        <div class="col-md-2 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-user {{ $errors->has('no_rm') ? 'is-invalid' : '' }}" id="email" name="no_rm" aria-describedby="emailHelp" placeholder="Enter No RM." value="{{ $pasien->no_rm }}">
                        ...
                        <div class="col-md-2 form-group mb-3">
                            ...
                            <input type="number" class="form-control form-control-user {{ $errors->has('no_regis') ? 'is-invalid' : '' }}" id="email" name="no_regis" aria-describedby="emailHelp" placeholder="Enter No Registrasi." value="{{ $pasien->no_regis }}">
                        ...
                        <div class="col-md-3 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-user {{ $errors->has('no_dana_sehat') ? 'is-invalid' : '' }}" id="email" name="no_dana_sehat" aria-describedby="emailHelp" placeholder="Enter No Dana Sehat." value="{{ $pasien->no_dana_sehat }}">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-user {{ $errors->has('tempat_lahir') ? 'is-invalid' : '' }}" id="email" name="tempat_lahir" aria-describedby="emailHelp" placeholder="Enter Tempat Lahir." value="{{ $pasien->tempat_lahir }}">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="date" class="form-control form-control-user {{ $errors->has('tanggal_lahir') ? 'is-invalid' : '' }}" id="email" name="tanggal_lahir" aria-describedby="emailHelp" placeholder="Enter Tanggal Lahir." value="{{ $pasien->tanggal_lahir }}">
                        ...
                        <div class="col-md-4 form-group mb-3">
                            ...
                            <select name="agama" class="form-control {{ $errors->has('agama') ? 'is-invalid' : '' }}">
                                ...
                                @foreach([1, 2, 3, 4, 5] as $agama)
                                    ...
                                    @endphp
                                    <option value="{{ $agama }}" {{ $pasien->agama == $agama ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-user {{ $errors->has('pekerjaan') ? 'is-invalid' : '' }}" id="email" name="pekerjaan" aria-describedby="emailHelp" placeholder="Enter Pekerjaan." value="{{ $pasien->pekerjaan }}">
                        ...
                        <div class="col-md-4 form-group mb-3">
                            ...
                            <input type="number" class="form-control form-control-user {{ $errors->has('telepon') ? 'is-invalid' : '' }}" id="email" name="telepon" aria-describedby="emailHelp" placeholder="Enter Telepon." value="{{ $pasien->telepon }}">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="number" class="form-control form-control-user {{ $errors->has('usia') ? 'is-invalid' : '' }}" id="email" name="usia" aria-describedby="emailHelp" placeholder="Enter Usia." value="{{ $pasien->usia }}">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <select name="jenis_kelamin" class="form-control {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}">
                                ...
                                @foreach([1, 2] as $gender)
                                    ...
                                    <option value="{{ $gender }}" {{ $pasien->jenis_kelamin == $gender ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <select name="status" class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}">
                                ...
                                @foreach([1, 2] as $status)
                                    ...
                                    <option value="{{ $status }}" {{ $pasien->status == $status ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <select name="is_anggota" class="form-control {{ $errors->has('is_anggota') ? 'is-invalid' : '' }}">
                                ...
                                @foreach([1, 2] as $anggota)
                                    ...
                                    <option value="{{ $anggota }}" {{ $pasien->is_anggota == $anggota ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
