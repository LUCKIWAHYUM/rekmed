                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-user {{ $errors->has('nama_perawat') ? 'is-invalid' : '' }}" id="email" name="nama_perawat" aria-describedby="emailHelp" placeholder="Enter Nama Perawat." value="<?= old('nama_perawat') ?>">
