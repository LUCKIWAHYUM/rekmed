                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Atur Kata Sandi</h1>
                                </div>
                                <form class="user" action="{{ route('resetPassword') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="text"
                                            ...
                                            id="email" name="password" aria-describedby="emailHelp"
                                    ...
                                    <div class="form-group">
                                        <input type="text"
                                            class="form-control form-control-user {{ $errors->has('retype_password') ? 'is-invalid' : '' }}"
                                            id="email" name="retype_password" aria-describedby="emailHelp"
                                            placeholder="Enter retype new password." value="<?= old('retype_password') ?>">
                                        @if($errors->has('retype_password'))<span
                                            class="small text-danger mt-2">{{ $errors->first('retype_password') }}</span>@endif
                                    </div>
