...
class ObatController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'button' => true,
            'module' => [
                'url' => route('obat.create'),
                'name' => 'Tambah Obat'
            ]
        ];

        return view('admin.app.content.obat.index', compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.app.content.obat.add', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($checkObat < 1) {
            ...
            if($postObat->save()) {
                return redirect()->route('obat')->with('success', 'Obat baru berhasil ditambahkan');
            } else {
    ...
    public function edit($id)
    {
        ...
        $obat = Obat::find($id);
        return view('admin.app.content.obat.edit', compact('data', 'obat'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($checkObat) {
            ...
            if($obat->save()) {
                return redirect()->route('obat')->with('success', 'Obat baru berhasil diperbarui');
            } else {
    ...
    public function destroy($id)
    {
        $obat = Obat::find($id);
        $obat->delete();
        return redirect()->route('obat')->with('success', 'Obat berhasil di hapus');
    }
}
