                    ...
                    render: function (data, type, row) {
                        return `
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ site_url('apoteker', 'obat') . '/edit' }}/${row.id}">Edit</a>
                                <a class="dropdown-item" href="{{ site_url('apoteker', 'obat') . '/delete' }}/${row.id}">Hapus</a>
                            </div>
                        `;
                    }
                }
