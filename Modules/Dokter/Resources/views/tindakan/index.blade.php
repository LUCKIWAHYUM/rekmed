                    ...
                    render: function (data, type, row) {
                        return `
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ site_url('dokter', 'tindakan') . '/edit' }}/${row.id}">Edit</a>
                                <a class="dropdown-item" href="{{ site_url('dokter', 'tindakan') . '/delete' }}/${row.id}">Hapus</a>
                            </div>
                        `;
                    }
                }
