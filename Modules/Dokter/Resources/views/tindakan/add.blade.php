        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Tindakan</h6>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control form-control-user {{ $errors->has('price') ? 'is-invalid' : '' }}" id="email" name="price" aria-describedby="emailHelp" placeholder="Enter Harga Layanan." value="<?= old('price') ?>">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea placeholder="Enter Keterangan" class="form-control form-control-user {{ $errors->has('description') ? 'is-invalid' : '' }}" id="exampleFormControlTextarea1" rows="3" name="description"><?= old('description') ?></textarea>
